        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-md-offset-5">
                    <div class="cListHead">
                        <img class="tableImageHeader img-responsive" src="img/table/property.svg" />
                    </div>
                </div>
                <table class="table-striped col-lg-8 col-lg-offset-2">
                    ...
                    <tbody class="attr">
                        ...
                        while ($row) {
                            ...
                            echo '<td>'
                            . '<a class="tableProps tablePropsFirst" href="viewProperty.php?id='.$row['property_id'].'"><img class="tableImageSmall img-responsive" src="img/table/view.svg" /></a> '
                            . '<a class="tableProps" href="editCustomerForm.php?id='.$row['property_id'].'"><img class="tableImageSmall img-responsive" src="img/table/edit.svg" /></a> '
                            . '<a class="deleteCustomer tableProps" href="deleteCustomer.php?id='.$row['property_id'].'"><img class="tableImageSmall img-responsive" src="img/table/delete.svg" /></a> '
                            . '</td>';
                            echo '</tr>';
                            $row = $statementProperty->fetch(PDO::FETCH_ASSOC);
                        }
                ...
                <div class="row">
                    <p><a class="createHome" href="createPropertyForm.php">Create New Property</a></p>
                </div>
            </div>
        </div>
    </section>
