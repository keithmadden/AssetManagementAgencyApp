...
<body id="page-top" class="index">
    ...
    <section id="createCustomer">
        <div class="container">
            <div class="row">
                <form class="form-horizontal col-lg-9 col-lg-offset-3" id="createBranchForm" name="createBranchForm" action="createBranch.php" method="POST">
                    <table class="table-striped col-lg-6" border="0">
                        <tbody>
                            ...
                            <tr class="subheadings">
                                <td><img class="tableImageSmall img-responsive" src="img/table/user.svg" /></td>
                                <td>
                                    <input class="form-control" type="text" name="manager" value="manager" />
                                    <span id="managerError" class="error"></span>
                                </td>
                            </tr>
                            <tr class="subheadings">
                                <td><img class="tableImageSmall img-responsive" src="img/table/clock.svg" /></td>
                                <td>
                                    <input class="form-control" type="text" name="hours" value="hours" />
                                    <span id="hoursError" class="error"></span>
                                </td>
                            </tr>
                                <td></td>
                                <td>
                                    <input class="btn btn-default btnForm" type="submit" value="Create Branch" name="createBranch" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
